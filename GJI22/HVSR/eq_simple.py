...
time1 = UTCDateTime("2019-11-06T14:00:00")
time2 = UTCDateTime("2019-11-06T16:00:00")
st_name='AEB05'
print('Doing station:',st_name)
st = client_5g.get_waveforms("5G", st_name, "*", "*", time1, time2)

data = os.path.join('data/', '')
file_name=data+'5G.{}.4jan.miniseed'.format(st_name)
st.write(file_name,format="MSEED")

# file_name = "5G.{}.4jan.miniseed".format(st_name)
...
# plt.title('{}'.format(st_name))
fig.suptitle('{}'.format(st_name), fontsize=10)
plt.savefig('figs/{}_19_4oct_8_10.pdf'.format(st_name),bbox_inches='tight', pad_inches=0.15)
