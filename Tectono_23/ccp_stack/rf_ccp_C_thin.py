...
prof_a=['AEB10','AEB06','AEB05','AEB03','AEB02','AES17','AES18','AES19','AES07','AEB07','AES20']# E-W along SA border
prof_b=['AEB07','AEB08','AEB09','AEB11','AEB13','AEB12']# N-S east array
prof_c1=['AEB02','AES07','AES08','AES09','AES11','AES10','AES12','AEB14']#'AEB01'
prof_c2=['AES13','AEB15','AES15','AEB16','AEB17','AEB18','AEB19','AEB20','AES20']# middle line
prof_c3=['AES01','AES04','AES16','AES14','AEB04','AES06']#'AES02','AES03','AES05'# west line

prof_c_big=prof_c2+prof_c3
...
AusArray_st=['TWINS','MILCK','BILLA','STUCK','PARAK','MULGA','WITCH','WILPO',\
'ARCOO','BOSWO','OOAKD','SOGAP','KOOTA','WIRRE']# ADD 'NILPI','MERNA',

AusArray_st_thin=['BILLA','STUCK','PARAK','MULGA','ARCOO','BOSWO','SOGAP']# ADD 'NILPI','MERNA',

client_sa = Client('http://auspass.edu.au:8080',user='6k',password='melon93')
inventory_sa = client_sa.get_stations(network='6K', station=','.join(AusArray_st_thin),level='response')

# for station_6K in AusArray_st:
for station_6K in AusArray_st_thin:
    try:
...
####
rf_all.write('rfs_CC_thin.H5', 'H5')
print('Len of rf_all=',len(rf_all)) # 3664!
...
boxes = get_profile_boxes((-25.5, 133.8), 147.67, np.linspace(0, 850, 171), width=200)
...
plt.savefig('pp_50km_CC_thin.pdf',bbox_inches='tight', pad_inches=0.1)
plt.show()
...
pstream_temp.normalize().plot_profile(scale=4,figsize=(40, 11), top='hist',fillcolors=('indianred', 'lightsteelblue'))#,moveout_model='ak135')
plt.gcf()#.set_size_inches(50, 10)
plt.savefig('ccp_50km_CC_thin_>4rfs.pdf',bbox_inches='tight', pad_inches=0.1)
plt.show()
